...
export const mockData = {
    board: {
      _id: 'board-id-01',
      title: 'WorkWithMe Board 1',
      description: 'WorkWithMeBoard',
      type: 'public', // 'private'
      ...
      columns: [
          ...
          cards: [
            {
              ...
              attachments: ['test attachment 03', 'test attachment 02', 'test attachment 01']
            },
        ...
        },
        {
          ...
          cards: [
            { _id: 'card-id-14', boardId: 'board-id-01', columnId: 'column-id-04', title: 'Title of card 15', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
          ]
        }
      ]
    }
